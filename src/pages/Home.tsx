...
import  PlanningServices  from "@/components/planning-services"
      ...
      <footer className="bg-gray-900 text-white py-12 relative overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">Say Yes</span>
              </div>
              <p className="text-gray-400 text-sm">
                Plan the Day You'll Never Forget. Your perfect wedding planning partner in Delhi-NCR. Find the best
                venues, vendors, and inspiration for your special day.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4 mb-4">
                <Link to="#" className="bg-white/10 p-2 rounded-full hover:bg-rose-500 transition-colors">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
            <p>© {new Date().getFullYear()} Say Yes. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
